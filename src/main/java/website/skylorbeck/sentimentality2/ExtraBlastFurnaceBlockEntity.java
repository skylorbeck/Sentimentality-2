...
public class ExtraBlastFurnaceBlockEntity extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider, Tickable {
    ...
    protected ExtraBlastFurnaceBlockEntity() {
        super(Declarer.EXTRA_BLAST_FURNACE_ENTITY);
        this.inventory = DefaultedList.ofSize(3, ItemStack.EMPTY);
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch (index) {
                    case 0:
                        return ExtraBlastFurnaceBlockEntity.this.burnTime;
                    case 1:
                        return ExtraBlastFurnaceBlockEntity.this.fuelTime;
                    case 2:
                        return ExtraBlastFurnaceBlockEntity.this.cookTime;
                    case 3:
                        return ExtraBlastFurnaceBlockEntity.this.cookTimeTotal;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0:
                        ExtraBlastFurnaceBlockEntity.this.burnTime = value;
                        break;
                    case 1:
                        ExtraBlastFurnaceBlockEntity.this.fuelTime = value;
                        break;
                    case 2:
                        ExtraBlastFurnaceBlockEntity.this.cookTime = value;
                        break;
                    case 3:
                        ExtraBlastFurnaceBlockEntity.this.cookTimeTotal = value;
                }
    ...
    protected int getFuelTime(ItemStack fuel) {
        if (fuel.isEmpty()) {
            ...
            return (Integer)FuelRegistry.INSTANCE.get(fuel.getItem())/2;
        }
