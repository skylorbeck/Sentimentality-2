...
public abstract class AbstractExtraFurnaceBlock_backup extends BlockWithEntity {
    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;
    public static final BooleanProperty LIT = Properties.LIT;
    private static final IntProperty DIM = IntProperty.of("dim",0,2);

    protected AbstractExtraFurnaceBlock_backup(Settings settings, int dimension) {
        super(settings);
