...
public class ExtraCraftingScreenHandler extends AbstractRecipeScreenHandler<CraftingInventory> {
    private ExtraCraftingTableEntity entity;
    ...
    public ExtraCraftingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context, ExtraCraftingTableEntity tableEntity) {
        ...
        for (int i = 0; i < entity.size(); i++) {
            this.input.setStack(i,entity.getStack(i));
        }
    }
    ...
    public void close(PlayerEntity player) {
        super.close(player);
        for (int i = 0; i < entity.size() ; i++) {
            entity.setStack(i,this.input.getStack(i));
        }
    }
