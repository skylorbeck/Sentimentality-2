    ...
    protected ExtraFurnaceBlockEntity() {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch (index) {
                    case 0:
                        return ExtraFurnaceBlockEntity.this.burnTime;
                    case 1:
                        return ExtraFurnaceBlockEntity.this.fuelTime;
                    case 2:
                        return ExtraFurnaceBlockEntity.this.cookTime;
                    case 3:
                        return ExtraFurnaceBlockEntity.this.cookTimeTotal;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0:
                        ExtraFurnaceBlockEntity.this.burnTime = value;
                        break;
                    case 1:
                        ExtraFurnaceBlockEntity.this.fuelTime = value;
                        break;
                    case 2:
                        ExtraFurnaceBlockEntity.this.cookTime = value;
                        break;
                    case 3:
                        ExtraFurnaceBlockEntity.this.cookTimeTotal = value;
                }
